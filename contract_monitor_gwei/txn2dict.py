...
def txnJSON2Dict(JSONstring):
	...
	plt.title("${CONTRACT}: histogram of average gas per user per transaction")
...
files = [ "./transaction_data/${CONTRACT}.json" ]
